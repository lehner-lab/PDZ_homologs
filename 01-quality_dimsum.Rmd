...
ggsave(paste0("Figs/Fig1/FigS1A_fitness_correlations_and_distributions.pdf"), width=17.5, height=13.5)
```
...
ggsave(paste0("Figs/Fig1/Fig1G_fitness_correlation_777_808_b2.pdf"), width=3.3, height=3.5)
...
```{r}
correlations_pearson<-read.table(paste0("tmp_tables/fitness_correlations_pearson.csv"))
...
ggplot(correlations_pearson_long)+
  ...
  theme(axis.title=element_text(size=8), legend.position = "top", legend.title=element_blank(),legend.key.height= unit(0.2, 'cm'),
        legend.key.width= unit(0.2, 'cm'), axis.title.x =element_text(size=8), axis.title.y =element_text(size=8))
ggsave(paste0("Figs/Fig1/Fig1H_summary_replicate_correlations.pdf"), height=2.5, width=2)
