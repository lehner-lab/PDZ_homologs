...
ggsave(paste0("Figs/Fig2/FigS2Apred_vs_obs_mochi_all.pdf"), width=13, height=4)
...
ggsave(paste0("Figs/Fig2/FigS2Bmochi_folding_model_all.pdf"), width=13, height=2.5)
...
ggsave(paste0("Figs/Fig2/Fig2Bfolding_add_trait_erbin.pdf"), width=4, height=2.5)
...
ggsave(paste0("Figs/Fig2/Fig2Cobs_vs_pred_erbin.pdf"), width=4, height=2.5)
```
...
ggsave(paste0("Figs/Fig2/Fig2Ddistribution_correlations_ddg_obs_pred.pdf"), width=1.7, height=1.7)
```
