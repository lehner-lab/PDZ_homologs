...
ggsave(paste0("Figs/Fig1/Fig1J_aligned_heatmap_binding.pdf"), width=25, height=4)
...
ggsave(paste0("Figs/Fig1/Fig1J_aligned_heatmap_folding.pdf"), width=25, height=3)
...
singles_table_all$library_name<-gsub("_", "-", gsub(" binding ", "\n", (unlist(lapply(singles_table_all$library, lib_code_to_name, libraries_names, libraries_names_plots)))))
...
ggplot(singles_table_all[!is.na(class)][order(class, decreasing = T)])+
  ...
  ylab("bindingPCA\nnormalized fitness")
ggsave(paste0("Figs/Fig1/", "FigS1D_f_vs_b_scatters.pdf"), width=15, height=2.6)
```
